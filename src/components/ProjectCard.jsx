export const ProjectCard = ({ title, description, projectLink, gitHubProjectLink, imgProject, technologies }) => {
    return (
        <>
            <div className="md:w-96 h-104 mx-5 md:mt-16 mt-8 rounded-xl border-2 border-black shadow-gray-400 shadow-lg">
                <div className="w-full h-96 bg-primaryDark rounded-t-xl text-white">
                    <a href={gitHubProjectLink} target="_blank"><img
