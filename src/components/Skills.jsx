...
export const Skills = () => {
    ...
    return (
        <div id="skills" className="bg-gray-100 2xl:pt-28 pb-12 pt-16 dark:text-white transition duration-300">
            <h1 className="2xl:text-4xl text-3xl font-medium w-4/5 text-center border-b-2 mx-auto py-2 md:pb-6">Habilidades</h1>
            <div className="p-1 flex h-5/6 md:px-16 flex-col md:flex-row gap-4">
